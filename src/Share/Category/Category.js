    ...
    return (
        <div className='pt-8'>
            ...
            <div className='flex justify-center items-center bg-color'>
                ...
                <button  onClick={showSunglass} className='card-border'>
                ...
                <button onClick={showFashion} className='card-border'>
                ...
                <button onClick={showHome} className='card-border'>
                ...
                <button onClick={showTechnology} className='card-border'>
                ...
                <button onClick={showCosmetics} className='card-border'>
                ...
                <button onClick={showLuxuryFood} className='card-border'>
                ...
                <button onClick={showShoes} className='card-border'>
                ...
                <button onClick={showJewellery} className='card-border'>
                ...
                <button onClick={showWatch} className='card-border'>
